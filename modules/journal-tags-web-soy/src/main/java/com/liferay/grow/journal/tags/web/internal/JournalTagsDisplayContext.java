...
public class JournalTagsDisplayContext {
	...
	public JournalTagsDisplayContext(HttpServletRequest request) {
	...
	public SoyContext getEditorContext() {
		SoyContext soyContext = SoyContextFactoryUtil.createSoyContext();

		soyContext.put("hasTags", hasTags());
		soyContext.put("hasOfficial", hasOfficial());

		List<AssetTag> assetTags = getUnofficialTags();

		List<String> names =  assetTags.stream()
				.map(AssetTagModel::getName)
				.collect(Collectors.toList());

		soyContext.put("unofficialTags", names);
